	...
	public function POST($args)
	{
		...
		if (!isset($args['m_items']))
		{
			return tpl::render('redirect', array(
				'redirect_message' => '<p>You have to select atleast one menu item to perform a batch action. You will be redirected to the '.
		...
		if (isset($args['form_delete_selected_m_items']))
		{
			...
			return tpl::render('redirect', array(
				'redirect_message' => '<p>'.$deleted_row_count.' menu item(s) successfully deleted. You will be redirected to the '.
									  'previous page in 2 seconds.</p>',
				'redirect_delay' => 2,
				'destination_url' => url('admin/menu')
				));
