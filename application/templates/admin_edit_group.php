...
<div id="admin-content">
	...
	<form accept-charset="utf-8" class="form-style-one" method="post" action="<?php echo url('admin/groups/edit:'.$values['id']) ?>">
		<div>
		...
		<p class="non-text-fields">
			...
			<label>
				<input type="checkbox" name="perm[<?php echo $set_id ?>][<?php echo $perm_id ?>]" value="1" <?php echo $values['permissions'][$set_id] & $bit ? 'checked="checked"' : '' ?>/>
